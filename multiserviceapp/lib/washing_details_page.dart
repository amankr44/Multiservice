...
import 'package:multiserviceapp/washing_service_page.dart';

class Washing extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Washing Machine')),
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Washingservice()));
                  },
                )
            ...
            Container(
              height: 345,
              //color: Colors.blue,
              child: Image.asset('assets/images/washingpage.jpg'),
            ),
            Padding(
