...
import 'package:multiserviceapp/refri_service_page.dart';

class Refrigerator extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Refrigerator')),
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Refriservice()));
                  },
                )
            ...
            Container(
              height: 345,
              //color: Colors.blue,
              child: Image.asset('assets/images/refrigeratorpage.jpg'),
            ),
            Padding(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text('549',style: TextStyle(fontSize: 20),),
